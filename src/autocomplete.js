...
angular.module('google.places', [])
  ...
  //Service for check for valid place
  .factory('googlePlacesService', ['$window', function($window) {

    var service = {};
    service.isValidAddress = isValidAddress;
      ...
      return new Promise(function(resolve, reject) {
        ...
        geocoder.geocode({
          ...
          if (status === google.maps.GeocoderStatus.OK && results.length > 0) {
            ...
            console.log("IsValidAddress: ", results[0].formatted_address);
            return resolve(true);
